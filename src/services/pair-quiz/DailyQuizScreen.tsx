  ...
  if (loading && !quizData) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading Play & Win...</Text>
      </View>
    );
  }
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
          <View style={styles.startCard}>
            ...
            <Text style={styles.quizTitle}>{language === 'hindi' ? 'दैनिक प्रश्नोत्तरी' : 'Play & Win'}</Text>
            ...
            <TouchableOpacity style={[styles.startButton, !(quizData?.questions?.length > 0) && styles.startButtonDisabled]} onPress={handleStartQuiz} disabled={!(quizData?.questions?.length > 0)}>
              ...
              <Text style={styles.startButtonText}>
                {language === 'hindi' ? 'दैनिक प्रश्नोत्तरी शुरू करें' : 'Start Play & Win'}
              </Text>
            </TouchableOpacity>
